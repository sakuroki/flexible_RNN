...
from pyrl.inactivation import Model_inact # added by sk 2017/2/28
...
if scratchpath is None:
    scratchpath = os.path.join(os.environ['USERPROFILE'], 'scratch')
...
#=========================================================================================
    ...
    model = Model_inact(modelfile) # only for inactivation experiment
