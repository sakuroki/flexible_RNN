...
for RNGSEED in range(1,21):
    ...
    # load last model files
    fn = 'path\\to\\last_model\\J_RNGSEED'+str(RNGSEED)+'.txt'
    ...
    fn = 'path\\to\\initial_model\\J_RNGSEED'+str(RNGSEED)+'_0.txt'
    ...
    # exclude output and contant input units
    ...
    # plot the sorted unit order
    Ws_sort_abs =  Wrec_diff[sort_id,:]
    Ws_sort_abs =  Ws_sort_abs[:,sort_id]
    pmax = np.max(np.abs(Wrec_diff.reshape(40000,)))
    ...
    # exclude output and constant input units
    sorted_val, sort_id = trans_list(sorted_val,sort_id,1)
    sorted_val, sort_id = trans_list(sorted_val,sort_id,10)
    sorted_val, sort_id = trans_list(sorted_val,sort_id,11)
    sorted_val, sort_id = trans_list(sorted_val,sort_id,0)

    # plot sorted unit order
    Ws_sort_abs =  Wrec_diff[sort_id,:]
    Ws_sort_abs =  Ws_sort_abs[:,sort_id]
    pmax = np.max(np.abs(Wrec_diff.reshape(40000,)))
    plt.pcolormesh(Ws_sort_abs,vmin = -pmax, vmax = pmax,cmap='jet')
    ...
    # exlude output and constant input units
    sorted_val, sort_id = trans_list(sorted_val,sort_id,1)
    sorted_val, sort_id = trans_list(sorted_val,sort_id,10)
    sorted_val, sort_id = trans_list(sorted_val,sort_id,11)
    sorted_val, sort_id = trans_list(sorted_val,sort_id,0)
